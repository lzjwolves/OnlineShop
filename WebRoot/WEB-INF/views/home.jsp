            ...
            <div class="bxslider-wrapper">
              <ul class="bxslider" data-slides-phone="1" data-slides-tablet="2" data-slides-desktop="5" data-slide-margin="15">
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model1.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model1.jpg" class="btn btn-default fancybox-button">查看大图</a>
                ...
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model2.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model2.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙2</a></h3>
                    <div class="pi-price">￥29.00</div>
                    <a href="#" class="btn btn-default add2cart">加入购物车</a>
                  </div>
                </li>
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model6.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model6.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙2</a></h3>
                ...
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model4.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model4.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="#">连衣裙4</a></h3>
                ...
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model5.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model5.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙5</a></h3>
                    <div class="pi-price">￥29.00</div>
                    <a href="#" class="btn btn-default add2cart">加入购物车</a>
                  </div>
                </li>
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model3.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model3.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙3</a></h3>
                    <div class="pi-price">￥29.00</div>
                    <a href="#" class="btn btn-default add2cart">加入购物车</a>
                  </div>
                </li>
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/model7.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/model7.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙3</a></h3>
        ...
        <div class="row margin-bottom-40 ">
          ...
          <div class="sidebar col-md-3 col-sm-4">
            <ul class="list-group margin-bottom-25 sidebar-menu">
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 女装</a></li>
              <li class="list-group-item clearfix dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="list-group-item dropdown clearfix">
                    <a href="javascript:void(0);"><i class="fa fa-circle"></i> 家电 <i class="fa fa-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li class="list-group-item dropdown clearfix">
                        ...
                        <li class="list-group-item dropdown clearfix">
                          <a href="javascript:void(0);"><i class="fa fa-circle"></i> 手机  <i class="fa fa-angle-down"></i></a>
                          <ul class="dropdown-menu">
                  ...
                  <li><a href="product-list.html"><i class="fa fa-circle"></i> 美食</a></li>
              ...
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 日常百货</a></li>
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 美食</a></li>
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 家电</a></li>
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 手机</a></li>
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 品牌</a></li>
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 生活百货</a></li>
              <li class="list-group-item clearfix"><a href="product-list.html"><i class="fa fa-angle-right"></i> 友情链接</a></li>
            </ul>
          </div>
          <!-- END SIDEBAR -->
          <!-- BEGIN CONTENT -->
            ...
            <div class="bxslider-wrapper">
              <ul class="bxslider" data-slides-phone="1" data-slides-tablet="2" data-slides-desktop="3" data-slide-margin="15">
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/k1.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/k1.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙</a></h3>
                ...
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/k2.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/k2.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙2</a></h3>
                ...
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/k3.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/k3.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙3</a></h3>
                ...
                <li>
                  <div class="product-item">
                    <div class="pi-img-wrapper">
                      <img src="assets/temp/products/k4.jpg" class="img-responsive" alt="连衣裙">
                      <div>
                        <a href="assets/temp/products/k4.jpg" class="btn btn-default fancybox-button">查看大图</a>
                        <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">详情</a>
                      </div>
                    </div>
                    <h3><a href="goods_detail.do">连衣裙4</a></h3>
                    <div class="pi-price">￥29.00</div>
                    <a href="#" class="btn btn-default add2cart">加入购物车</a>
                    <div class="sticker sticker-sale"></div>
                  </div>
                ...
                <li>
                  <div class="product-item">
                    ...
                    <h3><a href="goods_detail.do">连衣裙6</a></h3>
                    <div class="pi-price">￥29.00</div>
                    <a href="#" class="btn btn-default add2cart">加入购物车</a>
                  </div>
                </li>
              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="item active">
                    <img src="assets/temp/index-sliders/slide1.jpg" class="img-responsive" alt="连衣裙">
                  </div>
                  <div class="item">
                    <img src="assets/temp/index-sliders/slide2.jpg" class="img-responsive" alt="连衣裙">
                  </div>
                  <div class="item">
                    <img src="assets/temp/index-sliders/slide3.jpg" class="img-responsive" alt="连衣裙">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-3">
                  ...
                  <div class="product-other-images">
                    <a href="#" class="active"><img alt="连衣裙" src="assets/temp/products/model3.jpg"></a>
                    <a href="#"><img alt="连衣裙" src="assets/temp/products/model4.jpg"></a>
                    <a href="#"><img alt="连衣裙" src="assets/temp/products/model5.jpg"></a>
                  </div>
                </div>
...
Nostrud duis molestie at dolore.</p>
                  ...
                  <div class="product-page-cart">
                    ...
                    <button class="btn btn-default" type="submit">商品详情</button>
                  </div>
                </div>
